...
<body>
	...
	<section>
		<div id="main" class="col-12 col-md-12 col-lg-10 offset-lg-2">
			<h2>글쓰기 화면</h2>
			<form action="./adminInsertQna.reo" method="post" class="col-12">
				<input type="hidden" name="qna_email" value="trap302@gmail.com">
				<input type="hidden" name="qna_name" value="권영민">
